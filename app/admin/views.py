...
def delete_department(id):
    ...
    db.session.commit()
    flash("You have successfully deleted department")

    # redirect to departments page
    return redirect(url_for('admin.list_departments'))

    return render_template(title='Delete Departments')
...
def assign_employee(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("You have successfully added a role and department to employee")

        # redirec to the roles page
